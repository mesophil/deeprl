...
if __name__ == '__main__':
    ...
    normalize = torchvision.transforms.Normalize(mean=[0.4802, 0.4481, 0.3975], std=[0.2302, 0.2265, 0.2262])
    ...
    tiny_train = TinyImageNet(tinPath, transform=trainTransform, split='val')
    trainLoader = DataLoader(tiny_train, batch_size = 128, shuffle=True, pin_memory=True, num_workers=8)
